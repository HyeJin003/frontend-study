...
if(event.key ==='Enter'){
  ...
  <div className="flex gap-2">
    ...
    value={text} onKeyDown={handleKeyDown}  maxLength={200} className="flex-1 rounded-lg border border-gray-300 px-4 py-2 text-sm placeholder:text-gray-400 focus:outline-none"
