...
const completedCount = todos.filter (todo=>todo.completed).length
  ...
  return <TodoContext.Provider value={{todos, filter,filteredTodos,activeCount,completedCount,addTodo,toggleTodo,deleteTodo,editTodo,clearCompleted,toggleAll,setFilter}}>{children}</TodoContext.Provider>
}
