...
const varientClasses: Record<ButtonVariant, string> = {
  primary: "bg-blue-500 text-white hober:bg-blue-600 disabled:bg-blue-300",
  danger: "bg-red-500 text-white hober:bg-red-600 disabled:bg-red-300",
  ghost:
...
export default function Button({
  ...
  return <button disabled={isLoading || disabled} className="">{isLoading && (<span>)/</span>}</button>;
}
